    ...
    pub async fn resolve_dns(self) -> anyhow::Result<TargetAddr> {
        match self {
            ...
            TargetAddr::Domain(domain, port) => {
                println!("DEBUG  Attempt to DNS resolve the domain {}...", &domain);
                ...
                println!("DEBUG  domain name resolved to {}", socket_addr);
